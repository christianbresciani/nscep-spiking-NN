...
def main():
    ...
    # Load dataset
    if model == 'single':
        data_raw = np.load(f"datasets/vae_data/s1a_a{antenna}_ls2_12.pkl", allow_pickle=True)
    elif model == 'early':
        data_raw = np.load("datasets/vae_data/s1a_f_ls2_12.pkl", allow_pickle=True)
    elif model == 'delayed':
        # Load CSI from all the antennas and concatenate them together
        data_raw0 = np.load(f"datasets/vae_data/s1a_a0_ls2_12.pkl", allow_pickle=True)
        data_raw1 = np.load(f"datasets/vae_data/s1a_a1_ls2_12.pkl", allow_pickle=True)
        data_raw2 = np.load(f"datasets/vae_data/s1a_a2_ls2_12.pkl", allow_pickle=True)
        data_raw3 = np.load(f"datasets/vae_data/s1a_a3_ls2_12.pkl", allow_pickle=True)
    ...
    model = Model("SNN/har.pl", [net1, net2, net3, net4, net5, net6])
    ...
    return confmat.matrix.astype(int)
