...
activity(X,squat)  :- move_upper_arms_1(X,yes), move_upper_legs_2(X,no), move_upper_legs_3(X,yes), move_upper_legs_1(X,no).
activity(X,walk) :- move_upper_legs_1(X,yes), move_upper_legs_2(X,yes), move_upper_legs_3(X,yes), move_upper_arms_1(X,no).
